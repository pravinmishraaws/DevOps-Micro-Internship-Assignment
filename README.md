...
Read the [submission instructions](https://github.com/pravinmishraaws/devops-micro-internship-pravinmishra/blob/main/INSTRUCTIONS.md) before you start.
...
Example structure (you already have mostly this):

```text
DevOps-Micro-Internship (DMI)/
├── Week 0 - Assignment/
│   ├── Assignment: Basic Understanding of Internet, Networking & Tools Basics.md
│   ├── Task 1: Using ChatGPT as Your Learning Assistant.md
│   ├── Task 2: Internet and Networking.md
│   ├── Task 3: Application Architecture & Stack.md
│   ├── Task 4: Domain Name & DNS (Basic Concepts).md
│   ├── Task 5: Visual Studio Code Setup (Hands-on).md
│   └── Task 6: Publish Your Assignment as a LinkedIn Post.md
